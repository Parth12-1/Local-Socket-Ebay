...
public class Stores implements Serializable {
    ...
    public void addStoreProduct(int productID, String name2, String description, int quantity, double price,
                                int orderLimit) {
        storeProducts.add(new Products(productID, name2, description, quantity, price, orderLimit));
    }
